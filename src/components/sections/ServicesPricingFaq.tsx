...
import { faqs, pricingPlans, services } from "@/content/portfolio";

export const ServicesPricingFaq = () => (
  <>
      ...
      <div className="container-shell">
        ...
        <div className="border-t border-[#ded2c1]">
          {services.map(([number, title, text]) => (
            <article
              className="grid gap-4 border-b border-[#ded2c1] py-7 md:grid-cols-[80px_1fr_1.4fr]"
              key={title}
            >
